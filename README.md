...
```
Alternatively, you can download the full folder and place it inside bevfusion_ws/src/, then rename it to ```bashBEVFusion-ROS-TensorRT ```. This saves you from manually cloning and checking out the branch.
